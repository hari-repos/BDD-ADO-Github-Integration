...
define(["require", "exports"], function (require, exports) {
    ...
    (function (MigrationStatus) {
         ...
         */
        MigrationStatus[MigrationStatus["Active"] = 0] = "Active";
        /**
         * The migration has completed successfully.
         */
        MigrationStatus[MigrationStatus["Succeeded"] = 1] = "Succeeded";
        /**
         * The migration has completed with a failure. The error details can be found in the Migration.Error property.
         */
        MigrationStatus[MigrationStatus["Failed"] = 2] = "Failed";
        /**
         * The migration was suspended.
         */
        MigrationStatus[MigrationStatus["Suspended"] = 3] = "Suspended";
