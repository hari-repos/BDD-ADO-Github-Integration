...
export declare class GitRestClient extends RestClientBase {
     ...
     */
    getAccessibleRepositories(request: Git.GetAccessibleRepositoriesRequest): Promise<Git.GetAccessibleRepositoriesResponse>;
    /**
     ...
     */
    getPullRequestFilesDiff(repositoryId: string, pullRequestId: number, project?: string, iteration?: number, baseIteration?: number, top?: number, skip?: number): Promise<Git.GitPullRequestFilesDiff>;
    /**
     ...
     */
    getRefs(repositoryId: string, project?: string, filter?: string, includeLinks?: boolean, includeStatuses?: boolean, includeMyBranches?: boolean, latestStatusesOnly?: boolean, peelTags?: boolean, filterContains?: string, includeTargetBranches?: boolean): Promise<WebApi.PagedList<Git.GitRef>>;
    /**
