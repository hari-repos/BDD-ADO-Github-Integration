...
define(["require", "exports"], function (require, exports) {
     ...
     */
    var AlertMetadataErrorPolicy;
    (function (AlertMetadataErrorPolicy) {
        /**
         * Fail error policy: if an alert id is not found, the whole request fails.
         */
        AlertMetadataErrorPolicy[AlertMetadataErrorPolicy["Fail"] = 1] = "Fail";
        /**
         * Omit error policy: if an alert id is not found, it will be omitted from the results.
         */
        AlertMetadataErrorPolicy[AlertMetadataErrorPolicy["Omit"] = 2] = "Omit";
    })(AlertMetadataErrorPolicy = exports.AlertMetadataErrorPolicy || (exports.AlertMetadataErrorPolicy = {}));
    var AlertType;
    (function (AlertType) {
        /**
    ...
    (function (ValidationResult) {
         ...
         */
        ValidationResult[ValidationResult["TransientError"] = 5] = "TransientError";
