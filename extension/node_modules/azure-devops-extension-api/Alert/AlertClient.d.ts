...
export declare class AlertRestClient extends RestClientBase {
     ...
     * @param repository - The name or ID of the repository
     */
    getAlertsByIds(request: Alert.AlertBatchRequest, project: string, repository: string): Promise<Alert.Alert[]>;
    /**
     ...
     * @param repository - Name or id  of a repository that alert is part of
     */
    getAlertMetadata(project: string, alertId: number, repository: string): Promise<Alert.AlertMetadata>;
    /**
     * Get alerts metadata.
     *
     ...
     * @param repository - Name or id  of a repository that alert is part of
     */
    getAlertMetadataBatch(alertMetadataBatchRequest: Alert.AlertMetadataBatchRequest, project: string, repository: string): Promise<Alert.AlertMetadata[]>;
    /**
