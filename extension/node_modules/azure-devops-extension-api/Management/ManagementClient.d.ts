...
export declare class ManagementRestClient extends RestClientBase {
     ...
     *
     */
    getAdvancedSecurityAgentPoolSelection(): Promise<Management.AgentPoolDetails>;
    /**
     ...
     * @param agentPoolName -
     */
    updateAdvancedSecurityAgentPoolSelection(agentPoolName: string): Promise<Management.AgentPoolDetails>;
    /**
     ...
     */
    updateRepoAdvSecEnablementStatus2(repoEnablementSettings: Management.RepoEnablementSettings, project: string, repository: string): Promise<void>;
    /**
