...
define(["require", "exports", "../Common/RestClientBase"], function (require, exports, RestClientBase_1) {
    ...
    var ManagementRestClient = /** @class */ (function (_super) {
         ...
         *
         */
        ManagementRestClient.prototype.getAdvancedSecurityAgentPoolSelection = function () {
         ...
         * @param agentPoolName -
         */
        ManagementRestClient.prototype.updateAdvancedSecurityAgentPoolSelection = function (agentPoolName) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "7.2-preview.1",
         ...
         */
        ManagementRestClient.prototype.updateRepoAdvSecEnablementStatus2 = function (repoEnablementSettings, project, repository) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "7.2-preview.3",
