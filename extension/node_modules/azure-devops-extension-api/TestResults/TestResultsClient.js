...
define(["require", "exports", "../Common/RestClientBase", "../Common/Util/Serialization"], function (require, exports, RestClientBase_1, Serialization_1) {
    ...
    var TestResultsRestClient = /** @class */ (function (_super) {
         ...
         */
        TestResultsRestClient.prototype.deleteFlakyTestCaseRefIdsByBranch = function (project, repositoryId, branchInfo) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param branchInfo -
         */
        TestResultsRestClient.prototype.getFlakyTestCaseRefIdsByBranch = function (project, repositoryId, branchInfo) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        TestResultsRestClient.prototype.queryTestRuns = function (project, minLastUpdatedDate, maxLastUpdatedDate, state, planIds, isAutomated, publishContext, buildIds, buildDefIds, branchName, releaseIds, releaseDefIds, releaseEnvIds, releaseEnvDefIds, runTitle, top, sortOrder, continuationToken) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                var _this = this;
                return __generator(this, function (_a) {
         ...
         * @param project - Project ID or project name
         */
        TestResultsRestClient.prototype.callbackTestAgent = function (request, project) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "7.2-preview.1",
         ...
         * @param project - Project ID or project name
         */
        TestResultsRestClient.prototype.triggerTestAgent = function (request, project) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "7.2-preview.1",
         ...
         */
        TestResultsRestClient.prototype.getTestWeightedScoreByTestRun = function (project, runIds, includeAllOutcomes, onlyFlakyResults) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
