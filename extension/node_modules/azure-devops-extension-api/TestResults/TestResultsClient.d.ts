...
export declare class TestResultsRestClient extends RestClientBase {
     ...
     */
    deleteFlakyTestCaseRefIdsByBranch(project: string, repositoryId: string, branchInfo: Test.BranchInfo): Promise<number>;
    /**
     * @param project - Project ID or project name
     * @param repositoryId -
     * @param branchInfo -
     */
    getFlakyTestCaseRefIdsByBranch(project: string, repositoryId: string, branchInfo: Test.BranchInfo): Promise<Test.TestCaseFlakinessBranchInfo[]>;
    /**
     * @param project - Project ID or project name
     ...
     * @param project - Project ID or project name
     */
    callbackTestAgent(request: Test.TestAgentCallbackRequest, project: string): Promise<boolean>;
    /**
     * @param request -
     * @param project - Project ID or project name
     */
    triggerTestAgent(request: Test.TestAgentTriggerRequest, project: string): Promise<boolean>;
    /**
     ...
     */
    getTestWeightedScoreByTestRun(project: string, runIds: string, includeAllOutcomes?: boolean, onlyFlakyResults?: boolean): Promise<Test.TestCaseResult[]>;
    /**
