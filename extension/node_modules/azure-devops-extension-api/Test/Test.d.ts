...
export declare enum AdvancedFlakyDetectionMode {
    /**
...
export declare enum AdvancedFlakyDetectionParameterType {
    /**
...
export declare enum FlakyTestBugMetadata {
    /**
...
export declare enum TestRunSortOrderType {
    /**
