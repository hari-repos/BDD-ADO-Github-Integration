...
define(["require", "exports"], function (require, exports) {
    ...
    var AdvancedFlakyDetectionMode;
    (function (AdvancedFlakyDetectionMode) {
        /**
         * Advanced Flaky Detection is Disabled Mode
         */
        AdvancedFlakyDetectionMode[AdvancedFlakyDetectionMode["Disabled"] = 0] = "Disabled";
        /**
         * Advanced Flaky Detection is Preview Mode
         */
        AdvancedFlakyDetectionMode[AdvancedFlakyDetectionMode["Preview"] = 1] = "Preview";
        /**
         * Advanced Flaky Detection is Enabled Mode
         */
        AdvancedFlakyDetectionMode[AdvancedFlakyDetectionMode["Enabled"] = 2] = "Enabled";
    })(AdvancedFlakyDetectionMode = exports.AdvancedFlakyDetectionMode || (exports.AdvancedFlakyDetectionMode = {}));
    var AdvancedFlakyDetectionParameterType;
    (function (AdvancedFlakyDetectionParameterType) {
        /**
         * Failure rate parameter for flaky detection
         */
        AdvancedFlakyDetectionParameterType[AdvancedFlakyDetectionParameterType["FailureRate"] = 0] = "FailureRate";
        /**
         * Pass rate parameter for flaky detection
         */
        AdvancedFlakyDetectionParameterType[AdvancedFlakyDetectionParameterType["PassRate"] = 1] = "PassRate";
        /**
         * Timing variability parameter for flaky detection
         */
        AdvancedFlakyDetectionParameterType[AdvancedFlakyDetectionParameterType["TimingVariability"] = 2] = "TimingVariability";
        /**
         * Rerun count parameter for flaky detection
         */
        AdvancedFlakyDetectionParameterType[AdvancedFlakyDetectionParameterType["RerunCount"] = 3] = "RerunCount";
    })(AdvancedFlakyDetectionParameterType = exports.AdvancedFlakyDetectionParameterType || (exports.AdvancedFlakyDetectionParameterType = {}));
    /**
    ...
    (function (BranchType) {
         ...
         */
        BranchType[BranchType["None"] = 0] = "None";
        /**
         * Branch reference
         */
        BranchType[BranchType["Heads"] = 1] = "Heads";
        /**
         * Tag reference
         */
        BranchType[BranchType["Tags"] = 2] = "Tags";
        /**
         * Pull request reference
         */
        BranchType[BranchType["Pull"] = 3] = "Pull";
    ...
    var FlakyTestBugMetadata;
    (function (FlakyTestBugMetadata) {
        /**
         * Error Message of the Test Result
         */
        FlakyTestBugMetadata[FlakyTestBugMetadata["ErrorMessage"] = 1] = "ErrorMessage";
        /**
         * Stack Trace of the Test Result
         */
        FlakyTestBugMetadata[FlakyTestBugMetadata["StackTrace"] = 2] = "StackTrace";
        /**
         * Test Name
         */
        FlakyTestBugMetadata[FlakyTestBugMetadata["TestName"] = 3] = "TestName";
        /**
         * Machine Name
         */
        FlakyTestBugMetadata[FlakyTestBugMetadata["Machine"] = 4] = "Machine";
    })(FlakyTestBugMetadata = exports.FlakyTestBugMetadata || (exports.FlakyTestBugMetadata = {}));
    /**
    ...
    (function (TestResultsSettingsType) {
         ...
         */
        TestResultsSettingsType[TestResultsSettingsType["AdvancedFlakyDetection"] = 4] = "AdvancedFlakyDetection";
    ...
    var TestRunSortOrderType;
    (function (TestRunSortOrderType) {
        /**
         * Sort in ascending order.
         */
        TestRunSortOrderType[TestRunSortOrderType["Asc"] = 0] = "Asc";
        /**
         * Sort in descending order.
         */
        TestRunSortOrderType[TestRunSortOrderType["Desc"] = 1] = "Desc";
    })(TestRunSortOrderType = exports.TestRunSortOrderType || (exports.TestRunSortOrderType = {}));
    /**
